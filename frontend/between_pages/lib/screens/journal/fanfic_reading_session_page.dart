...
class FanficReadingSessionPage extends ConsumerStatefulWidget {
  final FanficJournalResponseDTO journal;

  const FanficReadingSessionPage({super.key, required this.journal});

  @override
  ConsumerState<FanficReadingSessionPage> createState() => _FanficReadingSessionPageState();
}

class _FanficReadingSessionPageState extends ConsumerState<FanficReadingSessionPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final fanficId = widget.journal.fanfic.idFanfic;
      if (fanficId != null && fanficId > 0) {
        ref.read(readingTimerProvider.notifier).start(fanficId, ReadingItemType.fanfic);
      }
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                autofocus: true,
                decoration: const InputDecoration(labelText: '¿En qué capítulo te has quedado?'),
              ),
  ...
  Future<void> _saveProgress(int newChapter) async {
    ...
    try {
      ...
      if (fanfic.idFanfic != null) {
        ref.invalidate(fanficJournalEntryProvider(fanfic.idFanfic.toString()));
      }
  ...
  Widget build(BuildContext context) {
    ...
    final bgAccent = const Color(0xFFD4A0A4); // Color for fanfic

    return Scaffold(
      backgroundColor: isDark ? const Color(0xFF1E1E1E) : const Color(0xFFFFF2F4),
      appBar: AppBar(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: SizedBox(
                      width: 140,
                      height: 210,
                      child: widget.journal.fanfic.coverUrl != null
                          ? CachedNetworkImage(imageUrl: widget.journal.fanfic.coverUrl!, fit: BoxFit.cover)
                          : Container(color: Colors.grey, child: const Icon(Icons.favorite, size: 40)),
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Text(
                    widget.journal.fanfic.title ?? 'Fanfic sin título',
                ...
                Row(
                  ...
                  children: [
                    FloatingActionButton.large(
                      heroTag: 'play_pause_fanfic',
                      backgroundColor: bgAccent,
                      foregroundColor: Colors.white,
                      onPressed: () {
                        final fanficId = widget.journal.fanfic.idFanfic;
                        if (fanficId == null) return;
