        ...
        return _buildGrid(
          ...
          (book) => CatalogItemCard(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => CatalogDetailPage(item: book, type: CatalogItemType.book),
              ),
            ),
          ),
        );
      ...
      data: (mangas) {
        ...
        return _buildGrid(
          ...
          (manga) => CatalogItemCard(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => CatalogDetailPage(item: manga, type: CatalogItemType.manga),
              ),
            ),
          ),
        );
      ...
      data: (fanfics) {
        ...
        return _buildGrid(
          ...
          (fanfic) => CatalogItemCard(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => CatalogDetailPage(item: fanfic, type: CatalogItemType.fanfic),
              ),
            ),
          ),
        );
