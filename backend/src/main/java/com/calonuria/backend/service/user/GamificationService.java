...
public class GamificationService {
    ...
    public GamificationStatsDTO getStats(String email) {
        ...
        // 1. Obtener la meta anual (por defecto 12 si no existe)
        ...
        // 3. Calcular la actividad de la semana (últimos 7 días)
    ...
    private int calculateStreak(List<LocalDate> sortedDates) {
        ...
        // Comprobar si la racha está viva (leyó hoy o ayer)
        if (sortedDates.get(0).equals(currentDate)) {
            ...
            return 0; // No leyó ni hoy ni ayer
        }

        // Contar días anteriores
